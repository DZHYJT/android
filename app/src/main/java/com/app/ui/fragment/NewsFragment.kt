 ...
 */
open class NewsFragment(private var newType: String, private var category: String) : Fragment() {
    ...
    protected fun getDataFromNetwork(): List<News>? {
    ...
    protected fun insertNewsToDataBase() {
        try {
            // 逆序插入的目的是让越早的新闻 id越小
